...
CREATE OR ALTER TRIGGER dbo.cms_posts_update
    on cms_posts
    AFTER UPDATE
                              AS
UPDATE cms_posts
...
CREATE OR ALTER TRIGGER dbo.cms_users_update
    on cms_users
    AFTER UPDATE
                              AS
UPDATE cms_users
...
CREATE OR ALTER TRIGGER dbo.cms_categories_update
    on cms_categories
    AFTER UPDATE
                              AS
...
CREATE OR ALTER TRIGGER dbo.cms_categories_posts_update
...
CREATE OR ALTER TRIGGER dbo.cms_comments
